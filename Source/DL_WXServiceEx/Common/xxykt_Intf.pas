...
const LibraryUID = '{F97EAB58-8821-4E57-A191-06725BF8CEB5}';
const TargetNamespace = 'xxykt';
const Ixxykt_IID: TGUID = '{334EB6CA-E6BE-4027-8BDB-7F293794A0CA}';
const xxykt_EndPointURI = 'http://192.168.1.254:81/xxykt.asmx';
type
  ...
  ['{334eb6ca-e6be-4027-8bdb-7f293794a0ca}']
    ...
    function Insert_Rd01(const cState: UnicodeString; const dDate: UnicodeString; const cCode: UnicodeString; const cVenCode: UnicodeString; const cCarNo: UnicodeString; const cInvCode: UnicodeString; 
                         const iQuantity: UnicodeString; const iUnitCost: UnicodeString; const iMoney: UnicodeString): UnicodeString;
    function VenInv(const cVenCode: UnicodeString): UnicodeString;
  end;

  Ixxykt_Async = interface(IROAsyncInterface)
  ['{221b6990-5647-4748-b6c5-26bc034321a7}']
    ...
    procedure Invoke_Insert_Rd01(const cState: UnicodeString; const dDate: UnicodeString; const cCode: UnicodeString; const cVenCode: UnicodeString; const cCarNo: UnicodeString; const cInvCode: UnicodeString; 
                                 const iQuantity: UnicodeString; const iUnitCost: UnicodeString; const iMoney: UnicodeString);
  ...
  ['{60010862-2598-4ea1-b533-de806a0c1fd0}']
    ...
    function BeginInsert_Rd01(const cState: UnicodeString; const dDate: UnicodeString; const cCode: UnicodeString; const cVenCode: UnicodeString; const cCarNo: UnicodeString; const cInvCode: UnicodeString; 
                              const iQuantity: UnicodeString; const iUnitCost: UnicodeString; const iMoney: UnicodeString; const aCallback: TROAsyncCallback; const aUserData: Pointer = nil): IROAsyncRequest;
...
begin
  ...
  lMessage.SetAttributes(lTransportChannel, ['action', 'inputchildrennamespace', 'location', 'outputchildrennamespace', 'remap_customer_ye', 'remap_insert_rd01', 'remap_insert_sale', 'remap_load_cus', 
                                             ...
                                             'style', 'type', 'use'], ['http://xxykt.org/Load_Data_mx', '*', 'http://192.168.1.254:81/xxykt.asmx', '*', 'http://xxykt.org/Customer_YE', 'http://xxykt.org/Insert_Rd01', 
...
begin
  ...
  lMessage.SetAttributes(lTransportChannel, ['action', 'inputchildrennamespace', 'location', 'outputchildrennamespace', 'remap_customer_ye', 'remap_insert_rd01', 'remap_insert_sale', 'remap_load_cus', 
                                             'remap_load_data_mx', 'remap_load_inv', 'remap_load_ven', 'remap_veninv', 'soapinputmessagenamespace', 'soapinputnameoverride', 'soapoutputmessagenamespace', 
                                             'style', 'type', 'use'], ['http://xxykt.org/Load_Inv', '*', 'http://192.168.1.254:81/xxykt.asmx', '*', 'http://xxykt.org/Customer_YE', 'http://xxykt.org/Insert_Rd01', 
                                             'http://xxykt.org/Insert_Sale', 'http://xxykt.org/Load_Cus', 'http://xxykt.org/Load_Data_mx', 'http://xxykt.org/Load_Inv', 'http://xxykt.org/Load_Ven', 'http://xxykt.org/VenInv', 
...
begin
  ...
  lMessage.SetAttributes(lTransportChannel, ['action', 'inputchildrennamespace', 'location', 'outputchildrennamespace', 'remap_customer_ye', 'remap_insert_rd01', 'remap_insert_sale', 'remap_load_cus', 
                                             'remap_load_data_mx', 'remap_load_inv', 'remap_load_ven', 'remap_veninv', 'soapinputmessagenamespace', 'soapinputnameoverride', 'soapoutputmessagenamespace', 
                                             'style', 'type', 'use'], ['http://xxykt.org/Load_Cus', '*', 'http://192.168.1.254:81/xxykt.asmx', '*', 'http://xxykt.org/Customer_YE', 'http://xxykt.org/Insert_Rd01', 
                                             'http://xxykt.org/Insert_Sale', 'http://xxykt.org/Load_Cus', 'http://xxykt.org/Load_Data_mx', 'http://xxykt.org/Load_Inv', 'http://xxykt.org/Load_Ven', 'http://xxykt.org/VenInv', 
...
begin
  ...
  lMessage.SetAttributes(lTransportChannel, ['action', 'inputchildrennamespace', 'location', 'outputchildrennamespace', 'remap_customer_ye', 'remap_insert_rd01', 'remap_insert_sale', 'remap_load_cus', 
                                             'remap_load_data_mx', 'remap_load_inv', 'remap_load_ven', 'remap_veninv', 'soapinputmessagenamespace', 'soapinputnameoverride', 'soapoutputmessagenamespace', 
                                             'style', 'type', 'use'], ['http://xxykt.org/Load_Ven', '*', 'http://192.168.1.254:81/xxykt.asmx', '*', 'http://xxykt.org/Customer_YE', 'http://xxykt.org/Insert_Rd01', 
                                             'http://xxykt.org/Insert_Sale', 'http://xxykt.org/Load_Cus', 'http://xxykt.org/Load_Data_mx', 'http://xxykt.org/Load_Inv', 'http://xxykt.org/Load_Ven', 'http://xxykt.org/VenInv', 
...
begin
  ...
  lMessage.SetAttributes(lTransportChannel, ['action', 'inputchildrennamespace', 'location', 'outputchildrennamespace', 'remap_customer_ye', 'remap_insert_rd01', 'remap_insert_sale', 'remap_load_cus', 
                                             'remap_load_data_mx', 'remap_load_inv', 'remap_load_ven', 'remap_veninv', 'soapinputmessagenamespace', 'soapinputnameoverride', 'soapoutputmessagenamespace', 
                                             'style', 'type', 'use'], ['http://xxykt.org/Customer_YE', '*', 'http://192.168.1.254:81/xxykt.asmx', '*', 'http://xxykt.org/Customer_YE', 'http://xxykt.org/Insert_Rd01', 
                                             'http://xxykt.org/Insert_Sale', 'http://xxykt.org/Load_Cus', 'http://xxykt.org/Load_Data_mx', 'http://xxykt.org/Load_Inv', 'http://xxykt.org/Load_Ven', 'http://xxykt.org/VenInv', 
...
begin
  ...
  lMessage.SetAttributes(lTransportChannel, ['action', 'inputchildrennamespace', 'location', 'outputchildrennamespace', 'remap_customer_ye', 'remap_insert_rd01', 'remap_insert_sale', 'remap_load_cus', 
                                             'remap_load_data_mx', 'remap_load_inv', 'remap_load_ven', 'remap_veninv', 'soapinputmessagenamespace', 'soapinputnameoverride', 'soapoutputmessagenamespace', 
                                             'style', 'type', 'use'], ['http://xxykt.org/Insert_Sale', '*', 'http://192.168.1.254:81/xxykt.asmx', '*', 'http://xxykt.org/Customer_YE', 'http://xxykt.org/Insert_Rd01', 
                                             'http://xxykt.org/Insert_Sale', 'http://xxykt.org/Load_Cus', 'http://xxykt.org/Load_Data_mx', 'http://xxykt.org/Load_Inv', 'http://xxykt.org/Load_Ven', 'http://xxykt.org/VenInv', 
...
begin
  ...
  lMessage.SetAttributes(lTransportChannel, ['action', 'inputchildrennamespace', 'location', 'outputchildrennamespace', 'remap_customer_ye', 'remap_insert_rd01', 'remap_insert_sale', 'remap_load_cus', 
                                             'remap_load_data_mx', 'remap_load_inv', 'remap_load_ven', 'remap_veninv', 'soapinputmessagenamespace', 'soapinputnameoverride', 'soapoutputmessagenamespace', 
                                             'style', 'type', 'use'], ['http://xxykt.org/Insert_Rd01', '*', 'http://192.168.1.254:81/xxykt.asmx', '*', 'http://xxykt.org/Customer_YE', 'http://xxykt.org/Insert_Rd01', 
                                             'http://xxykt.org/Insert_Sale', 'http://xxykt.org/Load_Cus', 'http://xxykt.org/Load_Data_mx', 'http://xxykt.org/Load_Inv', 'http://xxykt.org/Load_Ven', 'http://xxykt.org/VenInv', 
...
begin
  ...
  lMessage.SetAttributes(lTransportChannel, ['action', 'inputchildrennamespace', 'location', 'outputchildrennamespace', 'remap_customer_ye', 'remap_insert_rd01', 'remap_insert_sale', 'remap_load_cus', 
                                             'remap_load_data_mx', 'remap_load_inv', 'remap_load_ven', 'remap_veninv', 'soapinputmessagenamespace', 'soapinputnameoverride', 'soapoutputmessagenamespace', 
                                             'style', 'type', 'use'], ['http://xxykt.org/VenInv', '*', 'http://192.168.1.254:81/xxykt.asmx', '*', 'http://xxykt.org/Customer_YE', 'http://xxykt.org/Insert_Rd01', 
                                             'http://xxykt.org/Insert_Sale', 'http://xxykt.org/Load_Cus', 'http://xxykt.org/Load_Data_mx', 'http://xxykt.org/Load_Inv', 'http://xxykt.org/Load_Ven', 'http://xxykt.org/VenInv', 
...
begin
  ...
  try
    lMessage.StoreAttributes2(['action', 'inputchildrennamespace', 'location', 'outputchildrennamespace', 'remap_customer_ye', 'remap_insert_rd01', 'remap_insert_sale', 'remap_load_cus', 'remap_load_data_mx', 
                               ...
                               '*', 'http://192.168.1.254:81/xxykt.asmx', '*', 'http://xxykt.org/Customer_YE', 'http://xxykt.org/Insert_Rd01', 'http://xxykt.org/Insert_Sale', 'http://xxykt.org/Load_Cus', 
